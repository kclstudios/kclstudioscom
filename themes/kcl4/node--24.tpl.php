...
if (isset($node->field_child_pages['und'])) :
 $children = $node->field_child_pages['und']; 
 $child_count = count($children)-1;
 $count = 0;
    ...
    foreach($children as $child): 
      ...
      $teaser_img = isset($child_node->field_teaser_img['und']) ? $child_node->field_teaser_img['und'] : NULL; 


      
      if ($teaser_img) :   
     
          $teaser_path = image_style_url('thumbnail', $child_node->field_teaser_img['und'][0]['uri']);
...
?>
      ...
      <li>
        <a href="<?php print $child_url; ?>" class="ajax"><?php print '<img src="'. $teaser_path . '" >'; ?></a>   
         <?php if ($count != $child_count) : ?><div class="slideShadow"></div><?php endif; ?>   
      </li>
