var slideMenu=function(){
	...
	return{
		build:function(sm,sw,mt,s,sl,h){
			...
			for(i;i<l;i++){s=sa[i]; s.style.width=gw-1+'px'; this.timer(s)}//kclstudios - subtract 1 px to accomodate rounding up of li width
		...
		slide:function(s,c){
			...
			if((cw<st && !c) || (cw>gw && c)){
				...
				s.style.width=(w-owt)-1+'px';//kclstudios - again subtract 1 px to accomodate rounding up of li width
